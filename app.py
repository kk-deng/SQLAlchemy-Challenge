...
def main():    
    return (
        '<h1>Welcome to Hawaii API v1.0</h1><br>\
        <h2>This API accepts the following functions:</h2>\
...
# Tobs with start date route
@app.route("/api/v1.0/<start>")
def start_route(start): 
    session = Session(engine)
    
    # Add the '-' to entered dates for comparison of YYYY-MM-DD
...
# Tobs with start/end dates route
